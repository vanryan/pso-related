...
// vlneighs:The number of neighbors a paricle learns from (self-excluded)
    ...
    //Storage
    float Sto_SucEndFit[4][N-1]; // N-1 circumstances
    ...
    pso = fopen("fipso1.1-all-f1-f4.txt", "a+");
    ...
    pso = fopen("fipso1.1-all-f1-f4-SucEndFit.txt", "a+");
    for(i=0; i<N; i++)
        fprintf(pso,"%d,%1.30f,%1.30f,%1.30f,%1.30f\n",i+1,Sto_SucEndFit[0][i],Sto_SucEndFit[1][i],Sto_SucEndFit[2][i],Sto_SucEndFit[3][i]);
    fclose(pso);
    pso = fopen("fipso1.1-all-f1-f4-SucGens.txt", "a+");
    for(i=0; i<N; i++)
        fprintf(pso,"%d,%f,%f,%f,%f\n",i+1,Sto_SucGens[0][i],Sto_SucGens[1][i],Sto_SucGens[2][i],Sto_SucGens[3][i]);
    fclose(pso);
    pso = fopen("fipso1.1-all-f1-f4-SucRate.txt", "a+");
    for(i=0; i<N; i++)
        fprintf(pso,"%d,%f,%f,%f,%f\n",i+1,Sto_SucRate[0][i],Sto_SucGens[1][i],Sto_SucGens[2][i],Sto_SucGens[3][i]);
    fclose(pso);
}
