...
/*
 @Updating parameters
 vel_g for global, vel_l for local
 pbest for personal best
 lbest for best pbest in a neighborbood
 gbest for global (for real; Different from my other vicpso codes) best
*/
double vel_g[coornum], vel_l[coornum], pbest[coornum], lbest[coornum], gbest[dim+1];
