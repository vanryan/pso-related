...
int main()
{
    ...
    int i, j, k, l, varw, varc1, varc2, vfun=1, vtest, vgen, temp; // iteration vars
...
// Get da data in da file!
    for(i=0;i<70;i++){
        sprintf(buffer,"Gen%d,Item%d,",i,i);
    ...
    pso = fopen("vicpsoFunc1-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
