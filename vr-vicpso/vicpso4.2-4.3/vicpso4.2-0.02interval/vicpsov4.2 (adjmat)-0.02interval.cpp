...
//When the time comes they got loaded into the file, we'll have them become real 'average'
    ...
    float AveOptGen[14*5*4];  // FuncNumber*RadiusNumber: Every 70[radius] with a func
    float AveOptRate[280];  // FuncNumber*RadiusNumber: Every 70[radius] with a func
    float AveDeg[280][gennum/aveDegInterval+1];  // [FuncNumber*RadiusNumber][Every 10 gen]
