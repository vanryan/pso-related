...
// Get da data in da file!
    ...
    pso = fopen("c:/pso/vicpso4.4.4onlyveloneo/50/vicpsoFunc4-main.txt", "w");
    ...
    pso = fopen("c:/pso/vicpso4.4.4onlyveloneo/50/vicpsoFunc4-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/pso/vicpso4.4.4onlyveloneo/50/vicpsoFunc4-EndSucFit.txt","w");
    for(i=0; i<relRange;i++){
