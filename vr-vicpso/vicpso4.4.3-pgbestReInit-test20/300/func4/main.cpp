...
const int changeInte = 300; // The interval we change the perceptive radius
...
// Get da data in da file!
    ...
    pso = fopen("c:/pso/vicpsov4.4.3/300/vicpsoFunc4-main.txt", "w");
    ...
    pso = fopen("c:/pso/vicpsov4.4.3/300/vicpsoFunc4-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/pso/vicpsov4.4.3/300/vicpsoFunc4-EndSucFit.txt","w");
    for(i=0; i<relRange;i++){
