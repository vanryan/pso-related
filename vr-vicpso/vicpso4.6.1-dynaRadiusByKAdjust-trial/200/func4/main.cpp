...
const int testnum = 10; // Running times for experiments
                        ...
                        for(vgen = 0; vgen < gennum; vgen++)         // Evolution starts
                        {
                            ...
                            if( (vgen+1) % (changeInte) == 0 && vgen!=0)
                            {
                                ...
                                for(j=0;j<N;j++){
                                    ...
                                    if(j>=35){
                                        paramK[(int)fit[1][j]]+=kstep;
                                        if( paramK[(int)fit[1][j]] > kUpperLim )
                                             paramK[(int)fit[1][j]] = kUpperLim;
                                    }
...
// Get da data in da file!
    ...
    pso = fopen("c:/pso/dynaRadKSort1.1/200/vicpsoFunc4-main.txt", "w");
...
/*
    ...
    pso = fopen("c:/pso/dynaRadKSort1.1/200/vicpsoFunc4-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/pso/dynaRadKSort1.1/200/vicpsoFunc4-EndSucFit.txt","w");
    for(i=0; i<relRange;i++){
