...
int main()
{
    ...
    pso = fopen("vicpso1-4 - v3.csv", "w");
    fprintf(pso, "Vicpso:\n");

for(relRadius=0.5;relRadius<=1.3;relRadius+=0.1){ // Loop layer 1 (relRadius)
                ...
                for(vfun = 1; vfun < 4; vfun++)
                {
                    ...
                    for(vtest = 0; vtest < testnum; vtest++)  // Run the experiment
                    {
                        ...
                        */
                        ...
                        fprintf(pso,"\nDone--AveDeg, Func%d,Test%d\n",vfun,vtest);

                        printf("\nA test is done. The next one's coming at ya.\n\n");
                    } // for vtest
