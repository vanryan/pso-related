...
const int dim = 80; // Number of dimensions
const int N = 50; // Population; This will cause a waste of ram
const int testnum = 5; // Running times for experiments
...
// Get da data in da file!
    ...
    pso = fopen("c:/pso/vicpso4.5.0/vicpsoFunc4-main.txt", "w");
    ...
    pso = fopen("c:/pso/vicpso4.5.0/vicpsoFunc4-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/pso/vicpso4.5.0/vicpsoFunc4-EndSucFit.txt","w");
    for(i=0; i<relRange; i++)
    {
