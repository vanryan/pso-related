...
// Get da data in da file!
    ...
    pso = fopen("c:/onlyDynaRadius/150/vicpsoFunc4-main.txt", "w");
    ...
    pso = fopen("c:/onlyDynaRadius/150/vicpsoFunc4-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/onlyDynaRadius/150/vicpsoFunc4-EndSucFit.txt","w");
    for(i=0; i<relRange; i++)
    {
