...
// Get da data in da file!
    ...
    pso = fopen("c:/pso/dynaRadKSort1/500/vicpsoFunc2-main.txt", "w");
...
/*
    ...
    pso = fopen("c:/pso/dynaRadKSort1/500/vicpsoFunc2-OptFit.txt", "w");
    fprintf(pso, "%s\n",storage );
    ...
    pso = fopen("c:/pso/dynaRadKSort1/500/vicpsoFunc2-EndSucFit.txt","w");
    for(i=0; i<relRange;i++){
