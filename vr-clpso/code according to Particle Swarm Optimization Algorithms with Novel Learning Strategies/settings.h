...
const int refgap = 10; // 7; Set according to the paper "Comprehensive learning particle swarm optimizer for global optimization of multimodal functions"

/*
 Parameters for PSO
*/
const float wmax = 0.9;
const float wmin = 0.2;
const float para_c = 1;
